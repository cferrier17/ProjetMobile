...
public class MyHeroAdapter extends RecyclerView.Adapter<MyHeroAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Hero hero, OnHeroClickListener listener) {
    ...
    public MyHeroAdapter(List<Hero> myDataset, OnHeroClickListener listener) {
        values = myDataset;
    ...
    @Override
    public MyHeroAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
